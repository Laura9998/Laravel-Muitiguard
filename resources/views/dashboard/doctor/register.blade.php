            ...
            <div class="col-md-4 offset-md-4" style="margin-top: 45px;">
                ...
                <form action="{{ route('doctor.create') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="hospital" placeholder="Enter Your Hospital" value="{{ old('hospital') }}">
                    ...
                    <br>
                    <a href="{{ route('doctor.login') }}"> I already have an account, Log In Now </a>
                </form>
            </div>
        </div>
    </div>
